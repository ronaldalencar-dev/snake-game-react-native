...
* [x] Progressive speed increase (difficulty ramp-up)
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/Doidin22/snake-game-react-native.git](https://github.com/Doidin22/snake-game-react-native.git)
